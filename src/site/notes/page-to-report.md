...
![Pasted image 20240918093205.png](/img/user/Pasted%20image%2020240918093205.png)

## DELETE /users/{user_id}

Удаление пользователя.
Описание: Удаляет пользователя с указанным user_id из системы.
![Pasted image 20240918092833.png](/img/user/Pasted%20image%2020240918092833.png)
## PUT /users/{user_id}
